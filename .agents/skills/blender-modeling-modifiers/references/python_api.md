# Blender Modeling & Modifiers — Upstream Python Reference with MineLearning Guards

Upstream source: [python_api.md at 78e9151](https://github.com/ra100/blender-claude-plugin/blob/78e9151fdc9e01ce37f1d16a9b677c3047411885/skills/blender-modeling-modifiers/references/python_api.md).

This is a pattern library, not executable instruction. Verify every operator, property, enum, context, and target against the connected Blender 5.1.2 before use. Do not run “apply all,” transform apply, Remesh, Decimate, Dyntopo, auto-fill, mesh-data replacement, or global cleanup on a bound/production mesh. Use an isolated duplicate for experiments and preserve rig, animation, UV, shape-key, material-slot, parenting, pivot, and accepted proportion data.
...
# Blender 5.1.2 inspection: WeightedNormalModifier has no face_influence property.
```
...
# Boolean
# Blender 5.1.2 inspection: bmesh.ops.boolean is absent.
# Use a verified Boolean modifier/operator with explicit objects and context instead.
...
# Apply transforms (destructive; prohibited on bound/production meshes unless explicitly authorized)
