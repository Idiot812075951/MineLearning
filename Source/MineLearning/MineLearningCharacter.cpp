...
AMineLearningCharacter::AMineLearningCharacter()
{
	...
	Combat->Config = TSoftObjectPtr<UCombatConfig>(FSoftObjectPath(TEXT("/Game/MineLearning/Combat/DA_HumanCombat.DA_HumanCombat")));
...
void AMineLearningCharacter::NotifyControllerChanged()
{
...
void AMineLearningCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMineLearningCharacter::Move);
...
void AMineLearningCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMineLearningCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
